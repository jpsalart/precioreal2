(function (w) {
  ...
  function processQueue() {
    try {
      ...
      // IMPORTANT: do NOT auto-open when processing the queue.
      // Just resolve and (if caller wants) they can open later.
      openByBarcode(next, { newTab: false, open: false });
    } catch(e){}
  }
